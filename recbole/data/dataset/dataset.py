...
class Dataset:
    ...
    def _data_processing(self):
        ...
        """
        self.feat_name_list = self._build_feat_name_list()  # inter_feat, user_feat, item_feat
    ...
    def _load_data(self, token, dataset_path):
        ...
        """
        # loguru_logger.debug(f"Enter _load_data")
    ...
    def _load_inter_feat(self, token, dataset_path):
        ...
        Args:
            ...
            dataset_path (str): path of dataset dir.
        """
        # loguru_logger.debug(f"Enter _load_inter_feat")
        if self.benchmark_filename_list is None:
    ...
    def _load_feat(self, filepath, source):
        ...
        """
        # loguru_logger.debug(f"Enter _load_feat")
        self.logger.debug(
            set_color(
    ...
    def _remap_ID_all(self):
        ...
        for alias in self.alias.values():
            ...
            # loguru_logger.debug(f'alias: {alias}, remap_list: {remap_list}')
